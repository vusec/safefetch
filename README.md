This repository contains the source code for a Linux-based prototype of SafeFetch. The prototype is based on the [paper](https://download.vusec.net/papers/safefetch_sec24.pdf) 
